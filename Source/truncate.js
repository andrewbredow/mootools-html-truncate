/**
 * Based on the excellend nodejs-html-truncate by Yahoo!
 * https://github.com/huang47/nodejs-html-truncate
 * 
 * TODO:
 *  - Adapt test file from
 *  - Add to Mootools forge according to http://mootools.net/forge/how-to-add
 */
String.implement('truncateHTML', function (maxLength, options) {
    var string = this;
    var EMPTY_OBJECT = {},
        EMPTY_STRING = '',
